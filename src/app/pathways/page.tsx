...
export default function PathwaysPage() {
  ...
  const highlights = [
    {
      title: 'STEM to Non-STEM Pivot',
      text: 'STEM grads can explore teaching, policy, or business leadership roles.',
    },
    {
      title: 'Non-STEM to STEM Bridge',
      text: 'Short coding bootcamps or data analytics courses can open STEM careers.',
    },
    {
      title: 'Hybrid Pathways',
      text: 'Roles like Product Manager blend tech and business, open to both.',
    },
  ]
