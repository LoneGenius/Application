  ...
  return (
    <div style={{ fontFamily: "'Poppins', sans-serif" }}>
      ...
      <section className="bg-gradient-to-r from-purple-700 to-indigo-700 text-white py-24 text-center rounded-b-3xl shadow-2xl mb-16">
        ...
        >
          65% of Non-STEM Graduates in Malaysia <br /> Work Outside Their Field
        </motion.h1>
        <motion.p
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
...
>
  ...
  <ResponsiveContainer width="100%" height={280}>
    <BarChart data={salaryData}>
      ...
      <XAxis dataKey="field" stroke="#4B5563" /> {/* darker gray */}
      <YAxis stroke="#4B5563" />
      <Tooltip
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-20 rounded-2xl shadow-xl overflow-hidden mb-20 text-center">
        <motion.h1
        ...
        >
          Explore inclusive pathways, build essential skills, and chart your success with <span className="font-bold text-yellow-300">LaunchPad 🚀</span>
        </motion.p>
        <div className="mt-12 flex justify-center gap-8 flex-wrap">
          <a href="/careers" className="bg-yellow-300 text-indigo-800 font-bold px-8 py-4 rounded-full shadow-lg hover:shadow-2xl hover:scale-105 transition">
            Explore Careers
          </a>
          <a href="/skills" className="border-2 border-white px-8 py-4 rounded-full font-bold hover:bg-white/20 transition">
            View Skills
          </a>
          <a href="/pathways" className="bg-pink-200 text-indigo-900 font-bold px-8 py-4 rounded-full shadow-lg hover:shadow-2xl hover:scale-105 transition">
            Career Pathways
          </a>
        </div>
      </section>
      ...
      <section className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-12 max-w-6xl mx-auto">
        {[
          { icon: Rocket, title: 'Your Path Forward', desc: 'Clear, inclusive career roadmaps designed for every background.' },
          { icon: Star, title: 'Skill Building', desc: 'Master the skills employers value most with guided learning.' },
          { icon: Users, title: 'Support & Guidance', desc: 'Get personalized advice and mentorship along your journey.' },
