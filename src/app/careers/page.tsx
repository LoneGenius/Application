        ...
        {[
          {
            ...
            fact: 'High demand globally with strong remote opportunities.',
          },
          {
            title: 'Data Scientist',
            fact: 'One of the fastest-growing STEM careers with big data boom.',
          },
          {
            title: 'Teacher',
            fact: 'Essential for society, though often undervalued in pay.',
          },
          {
            title: 'Marketing Specialist',
            fact: 'Blends creativity with business strategy for modern markets.',
          },
        ].map((career, i) => (
          <motion.div
            key={i}
